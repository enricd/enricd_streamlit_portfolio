...
from projects.st_llms_arena.game_engine import game_engine
from projects.st_llms_arena.agents import AVAILABLE_MODELS, DEFAULT_PROMPT1, DEFAULT_PROMPT2
from utils.utils import contributor_card, enric_info
...
def main():
    ...
    with cols2[2]:
        ...
        board_imgs_space = st.image("projects/st_llms_arena/000_turn.png", use_column_width=True)
